...
# REDIRECT-PRIMING v2 (spec 2026-06-18 §3) — CONTINUOUS counterfactual R_meta.
# Moved to a TORCH-FREE module (intent-check w4udybnbv C6) so it is testable in
# any env and importable by the Stage-C producer without torch; fixes C1-C5.
# NOT wired into the live R_meta site (default behavior unchanged); see redirect_cf.py.
from src.training.redirect_cf import redirect_cf_rmeta, rmeta_pos, rmeta_neg  # noqa: F401,E402
